...
public class ProxyInfo
{
    ...
    public static final String PROXY = "IdInject";
    ...
    public String generateJavaCode()
    {
        ...
        builder.append("// Generated code. Do not modify   Maked by GYF!\n");
        builder.append("package ").append(packageName).append(";\n\n");
        builder.append("import lib.tzw.annotation_api.*;\n");
        builder.append('\n');
    ...
    public void putFiledVal(VariableElement variableElement,int val){
        injectVariables.put(val,variableElement);
    }
